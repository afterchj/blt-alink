...
public enum ResultDict {
    ...
    SUCCESS("000", "成功"), SYSTEM_ERROR("200", "系统错误"), ACCOUNT_NOT_CORRECT("101", "账号密码不正确！"), PASSWORD_NOT_CORRECT("102", "账号密码不正确！"),MOBILE_NOT_EXISTED("103", "该手机号未绑定！"),LIGHT_EXISTED("120", "有灯存在，冻结"),TOKEN_NOT_SUBMIT("107", "token没有提交"),TOKEN_NOT_CORRECT("108", "token失效"), TOKEN_REPLACED("109", "账号在其他设备登陆。"),
