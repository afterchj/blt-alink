...
public enum ResultDict {
    ...
    UNAME_REPET("201", "用户名已存在"),VERIFY_ERROR("202", "验证码不正确"),MOBILE_REPET("203", "该手机号已被绑定"),PARAMS_BLANK("301", "参数不能够为空"), PARAMS_NOT_PARSED("302", "参数解析错误"),MESHID_NOT_NULL("115","无此meshId"),
